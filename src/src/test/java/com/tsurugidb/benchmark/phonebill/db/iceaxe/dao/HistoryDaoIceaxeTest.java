...
//		}
	...
	final void testInsert() {
		...
		h.setCharge(null);
		h.setStartTime(DateUtils.toTimestamp("2022-08-30 16:15:28.312"));
	...
	final void testGetHistoriesCalculationTarget() {
		...
		History h007 = History.create("001", "456", "C", "2022-02-03 00:00:00.000", 5, 2, 0); // 検索対象外 -> endの境界値
		History h008 = History.create("001", "456", "C", "2022-02-03 00:00:00.001", 5, 2, 0); // 検索対象外 -> endの境界値
		History h009 = History.create("001", "456", "C", "2022-02-02 23:59:59.999", 5, 2, 0); // 検索対象 -> endの境界値
		...
		History h107 = History.create("151", "001", "R", "2022-02-03 00:00:00.000", 5, 2, 0); // 検索対象外 -> endの境界値
		History h108 = History.create("151", "001", "R", "2022-02-03 00:00:00.001", 5, 2, 0); // 検索対象外 -> endの境界値
		History h109 = History.create("151", "001", "R", "2022-02-02 23:59:59.999", 5, 2, 0); // 検索対象 -> endの境界値
